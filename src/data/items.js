const ITEMS = [
    ...
    { id: 72, name: 'Item 2', description: 'Nice', sectionId: 1, ringId: 2, prevRingId: 3 },
    { id: 73, name: 'Item 3', description: 'Nice', sectionId: 1, ringId: 3, prevRingId: null },
    { id: 74, name: 'Item 4', description: 'Nice', sectionId: 1, ringId: 4, prevRingId: 3 },
    { id: 75, name: 'Item 5', description: 'Nice', sectionId: 1, ringId: 5, prevRingId: 2 },
    { id: 84, name: 'Item 4', description: 'Nice', sectionId: 1, ringId: 4, prevRingId: 3 },
    { id: 85, name: 'Item 5', description: 'Nice', sectionId: 1, ringId: 5, prevRingId: 2 },
    { id: 82, name: 'Item 2', description: 'Nice', sectionId: 1, ringId: 2, prevRingId: 3 },
    { id: 83, name: 'Item 3', description: 'Nice', sectionId: 1, ringId: 3, prevRingId: null },
    { id: 94, name: 'Item 4', description: 'Nice', sectionId: 1, ringId: 4, prevRingId: 3 },
    { id: 95, name: 'Item 5', description: 'Nice', sectionId: 1, ringId: 5, prevRingId: 2 },
